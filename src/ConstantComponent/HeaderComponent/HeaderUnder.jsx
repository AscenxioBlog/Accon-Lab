...
function HeaderUnder() {
  return (
    <header className="bg-sky-100 shadow-md text-black">
        <div className="max-w-6xl mx-auto px-4  flex justify-between items-center">
            ...
            <section className=' relative flex'>
                ...
                <button className=' relative px-6 py-2 rounded-tr-[5px] rounded-br-[5px] font-medium text-white bg-gradient-to-r from-sky-400 to-indigo-500 shadow-lg shadow-sky-400/30 hover:shadow-sky-400/50 transition-all duration-300 hover:scale-[1.02]'>search</button>
            </section>
