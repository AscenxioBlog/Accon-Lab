        ...
        <div className="max-w-6xl mx-auto px-4  flex justify-between items-center">
            ...
            <form onSubmit={handleSearch} className=' relative flex'>
                ...
                <input 
                    ...
                    className=' border-[1px] border-gray-500 bg-transparent w-[40vw] sm:w-[300px] md:pl-7 pl-2 text-black text-[11px] md:placeholder:text-[14px] focus:outline-none'
                />
                <button type="submit" className=' relative px-3 py-3 md:px-6 md:py-2 rounded-tr-[5px] rounded-br-[5px] font-medium text-white bg-gradient-to-r from-sky-400 to-indigo-500 shadow-lg shadow-sky-400/30 hover:shadow-sky-400/50 transition-all duration-300 hover:scale-[1.02]'>
