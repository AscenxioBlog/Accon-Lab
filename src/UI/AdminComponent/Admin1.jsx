    ...
    <div>
      <div className=" h-[100vh] relative flex bg-gray-100 lg:p-5 text-[14px] gap-[20px]">
        ...
        <div className="  lg:inline-block ">
          <nav
            ...
            className={`absolute z-50 md:relative mt-3 lg:mt-0 ${
              showMe ? "sm:-right-full" : " sm:right-2"
            }   bg-black lg:h-full h-[500px] lg:left-0 top-0 bottom-0 overflow-y-hidden group transition-all duration-700 bg-foraside rounded-[15px] text-white flex flex-col gap-3 p-[20px] overflow-x-hidden   `}
          >
        ...
        <div className=" flex-1 relative rounded-2xl shadow-xl overflow-y-scroll scrollbar-thumb-custom-orange scrollbar-thin scrollbar-corner-black scrollbar-track-slate-200">
          <nav className=" flex justify-between lg:fixed absolute items-center lg:right-[20px] sm:w-full lg:w-[79%] h-[30px] text-white ">
