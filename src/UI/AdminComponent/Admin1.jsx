...
function Admin1() {
  ...
  return (
    <div>
            ...
            <div className=" flex-1 bg-black rounded-2xl shadow-xl overflow-y-scroll scrollbar-thumb-custom-orange scrollbar-thin scrollbar-corner-black scrollbar-track-slate-200">
